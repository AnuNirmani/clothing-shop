<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-2xl text-gray-800">
            <span class="bg-gradient-to-r from-pink-400 via-blue-400 to-pink-500 bg-clip-text text-transparent">Create New Category</span>
        </h2>
    </x-slot>
                    ...
                    <form action="{{ route('categories.store') }}" method="POST">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name') }}" 
                                ...
                                required 
                                placeholder="e.g., Men's Wear, Women's Wear, Kids, etc.">
                            @error('name')
                        ...
                        <div class="mt-8 flex justify-end space-x-3">
                            <a href="{{ route('categories.index') }}" class="bg-white border-2 border-gray-300 hover:bg-gray-50 text-gray-700 font-bold py-3 px-6 rounded-lg shadow-sm hover:shadow-md transition-all duration-200">
                                Cancel
                            </a>
