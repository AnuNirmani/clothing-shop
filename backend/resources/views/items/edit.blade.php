                        ...
                        <div class="space-y-6">
                            ...
                            @if($item->image)
                                <div>
                                    ...
                                    <div class="mt-2">
                                        <img src="{{ asset('storage/' . $item->image) }}" alt="{{ $item->name }}" class="h-48 w-48 object-cover rounded-lg shadow-md border-2 border-pink-100">
                                    </div>
                                </div>
                            @endif
                            ...
                            <!-- Image Upload -->
                            <div>
                                <label for="image" class="block text-sm font-semibold text-gray-700 mb-2">{{ $item->image ? 'Change Image' : 'Upload Image' }}</label>
