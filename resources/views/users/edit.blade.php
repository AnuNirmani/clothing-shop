                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white shadow-lg rounded-2xl border border-blue-100 p-6">
                        ...
                        <div class="space-y-4">
                            <!-- Current Password -->
                            <div>
                                <label for="current_password" class="block font-semibold mb-2 text-gray-700">Current Password</label>
                                <input
                                    id="current_password"
                                    type="password"
                            ...
                            <!-- New Password -->
                            <div>
                                <label for="password" class="block font-semibold mb-2 text-gray-700">New Password</label>
                                <input
                                    id="password"
                                    type="password"
                                    name="password"
                            ...
                            <!-- Confirm Password -->
                            <div>
                                <label for="password_confirmation" class="block font-semibold mb-2 text-gray-700">Confirm Password</label>
                                <input
